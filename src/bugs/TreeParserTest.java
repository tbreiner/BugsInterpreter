...
public class TreeParserTest {
    ...
    public final void testParse() {
         ...
         *    
         */
        t4 = new Tree<Token>(new Token("c"));
        t5 = new Tree<Token>(new Token("d"));
        t6 = new Tree<Token>(new Token("red"));
        t7 = new Tree<Token>(new Token("5"));
        t2 = new Tree<Token>(new Token("b"));
        t3 = new Tree<Token>(new Token("loop"));
        t1 = new Tree<Token>(new Token("a"));
